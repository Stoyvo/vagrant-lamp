...
function vstatus {
    ...
    echo -e "  Elastic Search Status:  $(if [[ $(sudo service elasticsearch status | grep 'is stopped')  == '' ]]; then echo '\033[1;32mOK\033[0;32m'; else echo '\033[1;31mStopped\033[0;32m'; fi)"
